    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('photo')) {
            ...
            User::create([
                ...
                'photo' => $path // Pastikan koma dipisahkan dengan tanda koma
            ]);
            ...
            if (Auth::attempt($credentials)) {
                ...
                return redirect()->route('login')->withError('Login failed. Please try logging in.');
            }
        } else {
            return redirect()->back()->withError('You did not upload a photo.');
        }
    }
